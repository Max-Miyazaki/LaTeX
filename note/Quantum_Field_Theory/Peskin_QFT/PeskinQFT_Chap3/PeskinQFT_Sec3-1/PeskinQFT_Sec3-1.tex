...
\color{blue}
※一般的な非線形変換が線形変換を元に構成できるかどうか, 調べたがよく分からなかったのでここでは省略する. 九後ゲージ場の量子論 II 6章「対称性の自発的破れ」の非線形表現を参照すると該当しそうな内容がある. 確証はないけど\dots
\vskip\baselineskip
\color{black}
...
\begin{itemize}
  ...
  回転群はスピンに応じて $n$ 次元の表現を持ち, スピン $s$ に対して $n = 2s + 1$ である.
  \vskip\baselineskip
  \color{red}
  そうなることを示す.
  \vskip\baselineskip
